...
class UsersServices extends ChangeNotifier {
  ...
  //     loginBox!.put('id', firebaseCurrentUser.uid);
  ...
  //   } else if(loginBox!.containsKey('id') && loginBox!.get('id') != null) {
  //     String? id = loginBox!.get('id');
  //     currentUsers = Users(
  //       id: id
  //     );
  ...
  //Implemntações usando SharedPreferences
  Future<bool> deleteUser() async {
    try {
      //Reautentica o usuário para evitar erro de "requires recent login"
      await reauthenticate();
