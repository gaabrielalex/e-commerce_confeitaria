        ...
        return DefaultFormOfProduct(
          ...
          onSave: () async {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              CSSnackBar(
                text: 'O processo de edição do produto está sendo realizado. Aguarde um momento...',
            ...
            bool response = await _productService.updateProduct(
              ...
              imageFile: (Provider.of<PickedImageService>(context, listen: false).webImage != null
            ...
            if (response) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                CSSnackBar(
                  text: 'Houve um erro ao atualizar o produto. Caso o erro persista, entre em contato com o suporte.',
          ...
          beforeBuildingContent: (snapshot) {
            ...
            _unitPrice.text = ViewUtils.formatDoubleToCurrency(productToUpdate!.unitPrice!);
